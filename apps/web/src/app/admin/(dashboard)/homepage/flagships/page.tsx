  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl font-bold text-slate-900">Homepage flagships</h1>
          <p className="text-sm text-slate-500">University initiatives carousel</p>
        </div>
        <Link
          href="/admin/homepage/flagships/new"
